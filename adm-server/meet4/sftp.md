...
- [X] FileZilla terinstall dan berfungsi
- [X] EC2 instance running
- [X] Berhasil koneksi SFTP ke server
- [X] Paham cara akses SSH via PowerShell
- [X] Ownership `/var/www/html` sudah diubah ke `ubuntu:ubuntu`
- [X] Berhasil edit dan upload file `index.html`
- [X] Website bisa diakses via browser dan responsive
