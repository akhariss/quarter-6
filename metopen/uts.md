# 📚 Belajar Metodologi Penelitian - UTS

**Metodologi Penelitian - Semester 6**
...
> Secara modern, penelitian adalah proses mengeksplorasi yang tidak diketahui, mempelajari hal-hal baru, dan membangun pengetahuan tentang hal-hal yang belum dipahami sebelumnya.

### Tujuan Penelitian

- ✅ Menciptakan ilmu pengetahuan baru
- ✅ Menerapkan teknologi untuk memecahkan masalah
- ✅ Menggunakan metode ilmiah yang valid
...
**Penalaran (Reasoning):** Proses berpikir menarik kesimpulan dari pernyataan yang dianggap benar.

### Struktur Penalaran

```
Input (Fakta, Data)
  → Proses (Penalaran Logis)
  → Output (Kesimpulan)
```

### Logika

> Studi tentang metode dan prinsip yang digunakan untuk membedakan penalaran yang tepat dari yang tidak tepat.

---

### Penalaran Deduktif

**Dari umum ke khusus** (general → specific)
...
- **Analitis** - Memecah pernyataan
- **Tautologis** - Kesimpulan sudah tersirat dalam premis
- **Apriori** - Tanpa pengamatan inderawi
- **Terukur** - Sahih/tidak sahih secara formal
...
**Dari khusus ke umum** (specific → generalization)

#### Alur Berpikir

```
Observasi Kasus Khusus
  → Pola
  → Hipotesis Sementara
  → Teori Umum
```
...
- **Sintetis** - Mensintesa kasus
- **A Posteriori** - Dari pengamatan empiris
- **General** - Menarik kesimpulan umum
- **Probabilistik** - Tidak mutlak, selalu ada aspek probabilitas

---

### 🎯 Quiz Interaktif: Deduktif vs Induktif

> **AI:** Nah, kharis. Kita sudah mempelajari penalaran deduktif dan induktif. Sekarang, coba tebak, apa perbedaan utama antara keduanya?

<details>
<summary><b>Pilihan Jawaban</b></summary>

- A) Keduanya sama saja
- B) Deduktif dari umum ke khusus, Induktif dari khusus ke umum
- C) Deduktif dari khusus ke umum, Induktif dari umum ke khusus
- D) Keduanya tidak ada hubungannya

<details>
<summary><b>✅ Jawaban: B</b></summary>

> **AI:** Tepat sekali, kharis! Ruka sangat bangga. Deduktif memang dari umum ke khusus, dan induktif sebaliknya. kharis hebat!

> ❌ **Kalau salah:** Eeh? Itu sedikit terbalik, kharis. Deduktif itu dari yang umum dulu, baru ke khusus. Mungkin kharis perlu rileks sedikit lagi?
...
**Pengetahuan:** Semua yang diketahui manusia (dari empiris, intuitif, otoritatif, logis)
...
### 🎯 Quiz Interaktif: Worldview

> **AI:** Oke, kharis. Sekarang, jika kita ingin memahami pengalaman pengguna aplikasi, worldview apa yang paling cocok kita gunakan?
...
<details>
<summary><b>✅ Jawaban: B (Interpretivisme)</b></summary>

> **AI:** Betul sekali, kharis! Pengalaman pengguna itu sangat subjektif, jadi Interpretivisme adalah pilihan terbaik. kharis memang cerdas!

> ❌ **Kalau jawab A:** Oh, kharis. Pengalaman pengguna itu lebih ke perasaan dan makna, jadi Positivisme kurang tepat. Ruka sedikit kecewa~

> ❌ **Kalau jawab C:** Hmm, Pragmatisme itu mencari solusi yang berhasil, tapi untuk memahami 'pengalaman', kita butuh lebih dari itu. Maaf, kharis, itu kurang tepat.
...
## 5. Paradigma & Pendekatan Penelitian
...
### 🎯 Quiz Interaktif: Klasifikasi Penelitian

> **AI:** kharis, jika kita ingin menguji pengaruh suatu sistem tutor AI terhadap nilai ujian mahasiswa, jenis penelitian apa yang paling tepat?
...
<details>
<summary><b>✅ Jawaban: B (Eksperimen)</b></summary>

> **AI:** Benar sekali, kharis! Penelitian Eksperimen adalah yang paling cocok untuk menguji pengaruh atau hubungan sebab-akibat. kharis memang luar biasa!

> ❌ **Kalau jawab A:** Ah, kharis, itu kurang tepat. Kita ingin 'menguji pengaruh', bukan hanya 'menggambarkan'. Itu berarti ada sebab-akibat yang ingin kita lihat.

> ❌ **Kalau jawab C:** Sayangnya bukan, kharis. Korelasional hanya melihat 'hubungan', bukan 'pengaruh'. Ada perbedaan tipis tapi penting di sana.
...
### Orisinalitas pada Metode DAN Masalah
...
>
> **Masalah:** Hanya mengganti objek tempat, tidak ada kontribusi ilmiah.
...
## 7. Identifikasi & Perumusan Masalah
...
- Kesenjangan penelitian sebelumnya (**research gap**)
- Permasalahan pada sistem/teknologi
- Kebutuhan industri/masyarakat
...
- ✅ Spesifik
- ✅ Terukur
- ✅ Relevan dengan bidang informatika
...
### Contoh Rumusan Masalah (Deteksi Stroke)
...
**Ruang lingkup** untuk membatasi permasalahan. **Bukan** tempat menguraikan kekurangan peneliti.
...
1. Dataset dari Kaggle, dengan atribut tertentu, tidak menggunakan data medis lain
2. Hanya menggunakan K-NN dan Naïve Bayes, tidak membandingkan algoritma lain
3. Evaluasi performa menggunakan Accuracy, Precision, Recall, tidak membahas ROC Curve
4. Fokus pada klasifikasi dan analisis performa, tidak mengembangkan sistem aplikasi medis
5. Implementasi di Python dengan Google Colab

---

### Tujuan Penelitian

**Pernyataan deklaratif** luaran teknis/pembuktian empiri.
...
- Validasi Metode (efektif/gagal)
- Pengembangan Ilmu (rekomendasi perbaikan parameter)

#### Manfaat Praktis

- Efisiensi Operasional (percepat proses)
...
**Jawaban sementara** terhadap rumusan masalah yang harus diuji kebenarannya melalui data empiris.
...
### 🎯 Quiz Interaktif: Hipotesis

> **AI:** Sekarang, kharis. Dalam kasus apa hipotesis *tidak wajib* disertakan dalam penelitian informatika?

<details>
<summary><b>Pilihan Jawaban</b></summary>

- A) Saat membandingkan dua algoritma secara kuantitatif
- B) Saat fokus membangun sistem atau aplikasi tanpa uji statistik
- C) Saat menguji hubungan sebab-akibat

<details>
<summary><b>✅ Jawaban: B</b></summary>

> **AI:** Benar sekali, kharis! Jika kita hanya fokus membangun sistem atau aplikasi tanpa uji statistik, hipotesis memang tidak wajib. kharis memang paling memahami!

> ❌ **Kalau jawab A:** Tidak tepat, kharis. Justru saat membandingkan dua algoritma secara kuantitatif, kita butuh hipotesis untuk menguji perbedaannya.

> ❌ **Kalau jawab C:** Itu juga kurang tepat, kharis. Menguji hubungan sebab-akibat itu justru inti dari hipotesis.
...
Proses mengidentifikasi, mengevaluasi, dan mensintesis penelitian sebelumnya yang relevan.
...
### Related Works (Tinjauan Penelitian Terkait)

Membahas penelitian sebelumnya yang memiliki kesamaan (topik, metode, objek, dataset).
...
#### ✅ Sumber Diperbolehkan

- Buku teks akademik
- Jurnal ilmiah, Prosiding konferensi
- Dokumentasi resmi teknologi (React.js, Oracle, Python)

#### ❌ Sumber Dilarang keras!

- Blogspot, WordPress, Wikipedia, SlideShare
- Media sosial
- Tugas kuliah mahasiswa lain

> ⚠️ Sumber tersebut tidak melalui proses **peer review**!
...
> 💡 **Analogi:** Membangun gedung, kita tidak membuat batu bata sendiri. Ilmu pengetahuan: setiap penelitian berdiri di atas bahu penelitian sebelumnya. Sitasi adalah cara kita mengakui bahu-bahu itu.
...
### 🎯 Quiz Interaktif: Gaya Sitasi

> **AI:** Baiklah, kharis. Dari keempat gaya sitasi yang sudah kita bahas, gaya mana yang paling direkomendasikan dan bahkan *wajib* untuk publikasi di jurnal informatika dan teknik?
...
<details>
<summary><b>✅ Jawaban: C (IEEE Style)</b></summary>

> **AI:** Tepat sekali, kharis! IEEE Style adalah jawaban yang benar. kharis memang paling memahami apa yang Ruka ajarkan!

> ❌ **Kalau jawab A:** Salah, kharis. APA memang umum, tapi bukan standar wajib untuk publikasi teknis.

> ❌ **Kalau jawab B:** Bukan itu, kharis. Harvard jarang sekali dipakai di informatika.

> ❌ **Kalau jawab D:** Vancouver Style dipakai di bidang kedokteran, bukan informatika.
...
*Catatan belajar UTS Metodologi Penelitian - Semester 6*
